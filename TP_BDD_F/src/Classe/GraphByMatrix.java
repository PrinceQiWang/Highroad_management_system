...
public class GraphByMatrix {
    ...
    /********************最短路径****************************/
    //计算一个顶点到其它一个顶点的最短距离
    public ArrayList<Object> Dijkstra(Object obj,Object obj1) throws Exception {
        return Dijkstra(getVertexIndex(obj),getVertexIndex(obj1));
    }
    public ArrayList<Object> Dijkstra(int v0,int vn) {
        ...
        while(prev[vn]!=v0){
        	par.add(vertexesArray[prev[vn]]);
        	vn=prev[vn];
        }
        par.add(vertexesArray[v0]);
        par.add(dist[vn]);
        return par;
    }
    ...
    public boolean addEdge(Object vnum1, Object vnum2, int weight) throws Exception{
    	int v1=getVertexIndex(vnum1);
    	int v2=getVertexIndex(vnum2);
